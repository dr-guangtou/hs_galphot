pro region_combine, input_image, reg_file, output_image, index = index 

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;  Convert a list of regions to mask image
;;  Written by Song Huang, 2011.09.13
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
on_error, 2
compile_opt idl2

if N_params() lt 3 then begin 
    print,  'Syntax - region_combine, input_image, reg_file, output_image, '
    print,  '         index = index   '
    return
endif
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
img_ori = input_image
img_msk = input_image
temp = size( input_image, /dimension ) 
naxis1 = temp[0] 
naxis2 = temp[1]
...
print, '############################################'
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
output_image = img_msk 
output_image[ where( output_image eq 1 ) ] = index 
output_image[ where( output_image ne index ) ] = 0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
end
